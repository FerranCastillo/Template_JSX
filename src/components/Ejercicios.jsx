...
import UserInfo from './ejerciciosBasicos/UserInfo';
...
export const Solucion = (props) => {
  let users = [
    { name: 'Ruben', age: 20, apellidos: 'teste' },
    { name: 'Laura', age: 22, apellidos: 'teste' },
    { name: 'Jose', age: 25, apellidos: 'teste' },
    { name: 'Osama', age: 30, apellidos: 'teste' },
  ];
  props.exercice >= 7 &&
    (users = [
      ...users,
  ...
  const [ejercicios, setEjercicios] = useState([
    <Ejercicio users={users} />,
    <Ejercicio2 users={users} />,
    <Ejercicio3 users={users} />,
    <Ejercicio4 users={users} />,
    <Ejercicio5 users={users} />,
    <Ejercicio6 users={users} />,
    <Ejercicio7 users={users} />,
    <Ejercicio8 users={users} />,
    <Ejercicio9 users={users} />,
    <Ejercicio10 users={users} />,
    <Ejercicio11 users={users} />,
    <Ejercicio12 users={users} />,
  ]);
...
export const SolucionUseState = (props) => {
  const [ejercicios, setEjercicios] = useState([<Contador />, <MostrarOcultar />, <Formulario />, <ListaBoton />]);
  return (
    <>
      <h2>Ejercicio {props.exercice}</h2>
      <hr />
